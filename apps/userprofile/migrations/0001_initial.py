        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "owner_name",
                    models.CharField(
                        max_length=100, null=True, verbose_name="Фамилия владельца"
                    ),
                ),
                (
                    "tenant_name",
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Фамилия жителя",
                    ),
                ),
                (
                    "address",
                    models.CharField(
                        max_length=100, null=True, verbose_name="Точный адрес"
                    ),
                ),
                (
                    "created_date",
                    models.DateField(
                        auto_now_add=True, null=True, verbose_name="Дата выдачи"
                    ),
                ),
                (
                    "manager",
