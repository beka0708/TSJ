...
class MyDetails(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name='profile', verbose_name="Пользователь", help_text="Чей профиль")
    cover = models.ImageField(upload_to='covers/', null=True, blank=True, verbose_name="Фото")
...
class Request(models.Model):
    ...
    number_phone = PhoneNumberField(null=True, blank=True, help_text='Пример: +996700777777', verbose_name='Номер телефона')
