    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "floors",
                    models.PositiveIntegerField(verbose_name="Количество этажей"),
                ),
                (
                    "entrances",
                    models.PositiveIntegerField(verbose_name="Количество подъездов"),
                ),
                (
                    "flats_number",
                    models.PositiveIntegerField(verbose_name="Количество квартир"),
                ),
            ],
            options={
                "verbose_name": "Дома",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("Новости", "Новости"), ("Объявления", "Объявления")],
                        max_length=100,
                        verbose_name="Тип",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=20,
                        verbose_name="Новость или Голосование",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "yes_count",
                    models.IntegerField(
                        default=0, verbose_name='Количество ответов "за'
                    ),
                ),
                (
                    "no_count",
                    models.IntegerField(
                        default=0, verbose_name='Количество ответов "нет'
                    ),
                ),
            ],
            options={
